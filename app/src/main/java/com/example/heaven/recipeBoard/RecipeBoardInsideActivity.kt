...
import com.example.heaven.databinding.ActivityRecipeBoardInsideBinding
...
class RecipeBoardInsideActivity : AppCompatActivity() {

    private val TAG = RecipeBoardInsideActivity::class.java.simpleName

    private lateinit var binding : ActivityRecipeBoardInsideBinding
...
//            }
//        }
//        FBRef.commentRef2.child(key).addValueEventListener(postListener)
